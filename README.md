...
-   Detailed protocols are in the [`protocol`](./protocol/) folder:
    - [`post-covid-events-renal`](protocol/post-covid-events-renal.pdf) contains the outcome-specific elements necessary to implement [`post-covid-events-ehrql`](protocol/post-covid-events-ehrql.pdf).
...
-   Analyses scripts are in the [`analysis`](./analysis) directory:
    ...
    -   Dataset cleaning scripts are in the ['dataset_clean'](./analysis/dataset_clean/) directory:
        ...
        -   [fn-inex_ps](analysis/dataset_clean/fn-inex_ps) is the project specific inclusion/exclusion function 
...
Detailed information about the outcomes can be found in the [`project-specific protocol`](protocol/post-covid-events-renal.pdf).
...
A concatenation of the flow descriptors generated by [`fn-inex.R`](./analysis/dataset_clean/fn-inex.R), [`fn-inex_ps`](./analysis/dataset_clean/fn-inex_ps.R), and [`fn-qa.R`](./analysis/dataset_clean/fn-qa.R), the inclusion/exclusion function and the quality assurance function.
