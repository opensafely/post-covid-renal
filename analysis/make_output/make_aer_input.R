...
input$unexposted_person_days_midpoint6 <- roundmid_any(input$unexposed_person_days)
input[, c("unexposed_events", "total_exposed", "sample_size", "unexposed_person_days")] <- NULL
